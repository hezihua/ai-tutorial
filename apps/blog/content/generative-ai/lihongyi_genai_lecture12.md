...
> **先備：** [語言模型內部運作](https://youtu.be/8iFvM7WUUs8)｜上一講：[Flash Attention](/courses/generative-ai/lihongyi_genai_lecture11)
...
| 集 | 主題 | 一句話 |
|----|------|--------|
| (1/2) | [Flash Attention](/courses/generative-ai/lihongyi_genai_lecture11) | 分塊 + Online Softmax，不寫完整 attention 矩陣，加速且 exact |
