    ...
    walkTree(tree, (node) => {
      ...
      const anchor: HastNode = {
        ...
        properties: {
          href: `#${id}`,
          class:
            "heading-anchor opacity-0 -ml-5 pr-1 text-neutral-600 hover:text-violet-400 transition-opacity no-underline border-none",
